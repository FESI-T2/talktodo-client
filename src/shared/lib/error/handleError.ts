...
export const getErrorMessage = (error: CustomError): string => {
  return (
    match(error.errorType)
      ...
      .with('SEC5000', () => '서버 에러가 발생했습니다.')
      .with('SEC5001', () => '서버 에러가 발생했습니다.')

      // 프론트엔드 전용 에러
      .with('NETWORK_ERROR', () => '네트워크 연결에 문제가 있습니다.')
